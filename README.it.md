...
<p align="center">
  <a href="README.zh-CN.md"><img src="https://img.shields.io/badge/🇨🇳_中文-1e293b?style=for-the-badge" alt="中文"/></a>
    ...
    <a href="README.it.md"><img src="https://img.shields.io/badge/🇮🇹_Italiano-a78bfa?style=for-the-badge" alt="Italiano"/></a>
...
**Estensione [3D Slicer](https://www.slicer.org/) per import DICOM in batch via [`dicom-forge`](https://github.com/DaCameraGirl/dicom-forge).**

Aggiunge **DICOM Forge Batch**: de-identificazione, QC, conversione NRRD, caricamento volumi.
