...
<p align="center">
  <a href="README.zh-CN.md"><img src="https://img.shields.io/badge/🇨🇳_中文-1e293b?style=for-the-badge" alt="中文"/></a>
    ...
    <a href="README.ar.md"><img src="https://img.shields.io/badge/🇸🇦_العربية-a78bfa?style=for-the-badge" alt="العربية"/></a>
</p>
...
**امتداد [3D Slicer](https://www.slicer.org/) لاستيراد DICOM دفعات عبر [`dicom-forge`](https://github.com/DaCameraGirl/dicom-forge).**

يضيف **DICOM Forge Batch**: إزالة الهوية وQC وتحويل NRRD وتحميل الحجوم.
